...
export const ProductCard = ({ product }) => {
  ...
  return (
    <div className={`bg-gray-100 p-4 border rounded-lg hover:shadow-md transition duration-300 mb-4 ${isHovered ? 'shadow-md' : ''}`}>
      <div className="flex justify-center mb-3">
        <img src={images[0]} alt={title} className="w-40 h-40 rounded" />
      </div>
      <div className="text-center">
        <h3 className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-2">{title}</h3>
