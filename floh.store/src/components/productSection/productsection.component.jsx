    ...
    return (
        <div className="">
            <div className="container mx-auto">
                <h2 className="text-2xl lg:text-4xl my-4 lg:mt-12 lg:mb-8 text-jet font-semibold">Neue Produkte</h2>
                <div className="relative w-full bg-platinum drop-shadow-lg lg:rounded-lg p-4 lg:p-8 items-center">
