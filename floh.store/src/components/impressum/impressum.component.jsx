export function ImpressumCompotent() {
  return (
    <>
      {" "}
        ...
        <div className="container mx-auto">
          <div className="mt-10 ">
            <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
              ...
              <p className="py-4 flex justify-start">Angaben gemäß § 5 TMG:</p>
              <p className=" flex justify-start">Walter White</p>
              <p className="flex justify-start">New Mexico 32</p>
              ...
              <p className="py-1 font-semibold">Haftung für Inhalte</p>{" "}
              <p className="py-4">
              ...
              <p className="py-1 font-semibold">Haftung für Links</p>
              <p className="py-4">
                {" "}
              ...
              <p className="py-1 font-semibold">Urheberrecht</p>
              <p className="py-4">
