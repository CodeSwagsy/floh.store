...
export function AddProductComponent() {
  ...
  async function uploadToCloud(file) {
    ...
    // formData.append("eager", "w_768,q_auto,f_auto");
    // const res = await fetch(
  ...
  const handleSubmit = async (e) => {
    ...
    if (!credentials.type) {
      setError(
        "Bitte wählen Sie aus, ob Sie einen Artikel suchen oder anbieten möchten."
      );
      return;
    }
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="flex max-md:flex-col justify-end gap-4 lg:mb-8 border-b pb-4 lg:pb-8">
                  <div className="flex max-md:flex-col gap-5 md:justify-between">
                    <label className="md:w-44 md:-mr-[1px]">
                      ...
                      />
                      <div className="hover:bg-gray-50 flex items-center justify-between px-4 py-2 ring-1 ring-inset focus:outline-none ring-emerald rounded-lg cursor-pointer text-sm border-emerald group peer-checked:border-emerald">
                        <h2 className="font-medium text-gray-700 mx-2">
                          Ich suche
                        </h2>
                        <svg
                ...
                <div className="flex max-md:items-center justify-between">
                  ...
                  <div className="flex w-48 max-md:w-full justify-end">
                    <select
                      ...
                      onChange={onChangeHandler}
                    >
                      <option className="pr-1" value="na" disabled>
                        Wählen sie aus...
                      </option>
                      <option className="text-left pr-1" value="Elektronik">
                        Elektronik
                      </option>
                      <option
                      ...
                      <option className="text-left pr-1" value="Fahrzeuge">
                        Fahrzeuge
                      </option>
                      <option
                        className="text-left pr-1"
                      ...
                      <option className="text-left pr-1" value="Tierbedarf">
                        Tierbedarf
                      </option>
                      <option
                        className="text-left pr-1"
                      ...
                      <option className="text-left pr-1" value="Sonstiges">
                        Sonstiges
                      </option>
                    </select>
                  </div>
                ...
                <div className="flex justify-between max-md:items-center">
                  ...
                  >
                    ...
                    <option className="text-left pr-1" value="Neu">
                      Neu
                    </option>
                    <option className="text-left pr-1" value="Sehr gut">
                      Sehr gut
                    </option>
                    <option className="text-left pr-1" value="Gut">
                      Gut
                    </option>
                    <option className="text-left pr-1" value="Akzeptabel">
                      Akzeptabel
                    </option>
                    <option className="text-left pr-1" value="Defekt">
                      Defekt
                    </option>
                  </select>
                </div>
                ...
                <div className="flex items-center justify-center w-full flex-col border-b pb-4 lg:pb-8">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="mb-2 text-sm  group-hover:text-whitesmoke">
                        <span className="font-semibold group-hover:text-whitesmoke">
                          Uploade deine Bilder
                        </span>{" "}
                        drag and drop
                      </p>
                  ...
                  <div className="flex flex-wrap gap-2 w-full">
                    {credentials.images &&
                      credentials.images.map((link, index) => (
                ...
                <div className="flex flex-row-reverse space-x-4 space-x-reverse">
                  <ButtonComponent
                    size="large"
                    spantxt="Jetzt Anzeige erstellen"
                    height="height"
                  />
                </div>
