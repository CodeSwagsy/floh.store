    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center md:py-12 sm:px-1.5 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-[700px]">
                <div className="md:bg-white px-2 py-4 md:py-8 md:shadow sm:rounded-lg md:px-12">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        <div className="flex max-md:flex-col justify-end gap-4 lg:mb-8 border-b pb-4 lg:pb-8">
                            <div className="flex max-md:flex-col gap-5 md:justify-between">
                                <label className="md:w-44 md:-mr-[1px]">
                                    ...
                                    <div
                                        className="hover:bg-gray-50 flex items-center justify-between px-4 py-2 ring-1 ring-inset ring-emerald rounded-lg cursor-pointer text-sm border-emerald group peer-checked:border-emerald">
                        ...
                        <div className="flex max-md:items-center justify-between">
                            ...
                            <input
                                ...
                                className="p-2.5 block max-md:w-full w-96 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-emerald placehoder:text-sm placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald focus:outline-none sm:text-sm sm:leading-6"
                            />
