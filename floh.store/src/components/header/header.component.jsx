            ...
            <div className="container mx-auto bg-whitesmoke">  {/*whitesmoke im css als body!*/}
                <div className="flex flex-row items-center gap-4">
                    ...
                    <div className="flex flex-row bg-slate-200 p-1 lg:p-3 rounded-lg overflow-hidden">
                        <img src="/lupe.svg" alt="lupe"/>
                        <label htmlFor=""></label>
                        <input className="bg-slate-200 " placeholder="Was suchst du?" type="text"/>
                    </div>
                    <a className="flex max-h- shadow-sm[70px] flex-row items-center justify-center gap-2 bg-slate-700 lg:px-4 lg:py-1.5 text-white max-lg:rounded-full rounded-lg">
                    ...
                    <a className="flex max-h- shadow-sm[70px] flex-row items-center justify-center gap-2 bg-slate-700 py-1.5 px-1 lg:px-4 lg:py-2 text-white rounded-lg">
                        <p className="text-sm lg:text-xl">Login / Registrieren</p>
                    </a>
                    <button>
                        <img src="/darkmode.svg" alt="Darkmode Lightmode Button"/>
                    </button>
                </div>
