                ...
                <div
                    ...
                    <div className="flex flex-col max-lg:items-center max-lg:justify-center">
                        ...
                        <ul className="flex flex-col max-lg:items-center mt-2">
                            ...
                            {/*<li className="hover:text-emerald transition-all"><Link to="/about">Unsere App</Link></li>*/}
                    ...
                    <div className="flex flex-col max-lg:items-center max-lg:justify-center max-lg:mt-4">
                        ...
                        <ul className="flex flex-col max-lg:items-center mt-2">
                            <li className="hover:text-emerald transition-all"><Link
                                to="/products/add">Verkaufen</Link>
                            </li>
                            <li className="hover:text-emerald hover:cursor-pointer transition-all"><p onClick={fetchGallery}>Alle
                                Anzeigen</p></li>
                            <li className="hover:text-emerald transition-all"><Link to="/products/random">Zufällige
                                Anzeige</Link></li>
                        </ul>
                    </div>
                    <div className="flex flex-col max-lg:items-center max-lg:justify-center max-lg:mt-4">
                        ...
                        <ul className="flex flex-col max-lg:items-center mt-2">
                            ...
                            <li className="hover:text-emerald transition-all"><Link to="/impressum">Impressum</Link>
                            </li>
                            <li className="hover:text-emerald transition-all"><Link to="/kontakt">Kontakt</Link>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="container mx-auto border-t border-gray-300 mt-4 flex gap-4">
                    <a href=""><FontAwesomeIcon icon={faSquareFacebook}
                                                className="mt-4  fa-2xl text-emerald hover:text-jet transition-all"/></a>
                    <a href=""><FontAwesomeIcon icon={faSquareInstagram}
                                                className="mt-4  fa-2xl text-emerald hover:text-jet transition-all"/></a>
                </div>
            </footer>
        </>
